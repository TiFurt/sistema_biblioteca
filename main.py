                ...
                case 3:
                    ...
                    match opcao_categoria:
                        ...
                        case 1:
                            ...
                            categoria_dao.cadastrar({Categoria(nome_categoria, descricao_categoria, assunto_categoria)})
                        ...
                        case 2:
                            ...
                            if id_categoria_alterar == -1:
                                ...
                                escolha_categorias = categoria_dao.get_categorias(id_categoria_alterar)
                                print('Escolha uma das opções abaixo: ')
                                print('1 - Nome : {categoria.get_nome()}')
                                print('2 - Descrição: {categoria.get_descricao()}')
                                print('3 - Assunto: {categoria.get_assunto()}')
                                opcao_alterar = int(input('Digite sua opção(0 para sair): '))
                                match opcao_alterar:
                                    case 0:
                                        print('Saindo...')
                                    ...
                                    case 1:
                                        ...
                                        categoria_dao.alterar_nome(escolha_categorias, nome_categoria)
                                    ...
                                    case 2:
                                        ...
                                        categoria_dao.alterar_descricao(escolha_categorias, descricao_categoria)
                                        print(f'Descrição da categoria alterado com sucesso para {descricao_categoria}!')
                                        input('Pressione enter para continuar...')
                                        pass
                                        
                                    case 3:
                                        assunto_categoria = str(input('Digite o novo assunto da categoria: '))
                                        categoria_dao.alterar_assunto(escolha_categorias, assunto_categoria)
